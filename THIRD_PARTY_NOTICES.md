...
- Project: <https://github.com/talkjs/country-flag-emoji-polyfill>
- Font wrapper: MIT License
- Emoji artwork: Twemoji, CC BY 4.0
- Local notice: [web/src/assets/flags/LICENSE.md](web/src/assets/flags/LICENSE.md)

## Package dependencies

Go and npm dependencies remain subject to the licenses declared by their respective authors. Package manifests and lock files identify the exact dependency versions used by this repository.

Go 与 npm 依赖继续遵循各自作者声明的许可证；仓库中的依赖清单和锁定文件记录了实际使用版本。
